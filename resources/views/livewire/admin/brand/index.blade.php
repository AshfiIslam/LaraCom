            ...
            <div class="card">
                <div class="card-header">
                    <h4>
                        ...
                        <br>
                        <br>
                        {{-- <a href="{{ url('admin/brand')}}" class="btn btn-primary">Add</a> --}}
                        <a href="#"  data-toggle="modal" data-target="#addBrandModal" class="btn btn-primary btn-sm float-left">Add Brands</a>
                    </h4>
                </div>
                <div class="card-body">
